    ...
    <div class="absolute inset-y-0 left-0 w-72 bg-[var(--color-card)] shadow-xl transition-transform p-6">
      ...
      <div class="space-y-6">
        ...
        <div class="flex flex-col gap-3">
          <RouterLink to="/settings" class="flex items-center gap-2.5 bg-indigo-500/10 hover:bg-indigo-500/20 border border-indigo-400/30 rounded-xl px-4 py-2.5 text-indigo-300 text-sm font-medium transition-colors">
            ...
            <RouterLink to="/" class="flex items-center gap-2.5 bg-indigo-500/10 hover:bg-indigo-500/20 border border-indigo-400/30 rounded-xl px-4 py-2.5 text-indigo-300 text-sm font-medium transition-colors">
             <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
